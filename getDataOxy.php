    ...
    if ($timeFrame === '24H') {
        ...
        try {
            ...
            foreach ($data as $row) {
                ...
                $doLevels[] = round($row['do_level'], 2); // Dissolved oxygen level with 2 decimal points
            }
    ...
    elseif ($timeFrame === '1M') {
        ...
        try {
            ...
            foreach ($data as $row) {
                ...
                $doLevels[] = round($row['do_level'], 2); // Round dissolved oxygen level to 2 decimal points
            }

    ...
    if ($timeFrame === '24H') {
        ...
        try {
            ...
            foreach ($data as $row) {
                ...
                $ammoniaLevels[] = round($row['ammonia_level'], 2); // Ammonia level with 2 decimal points
            }

            // Return data as JSON
            echo json_encode([
                'categories' => $categories,
                'ammoniaLevels' => $ammoniaLevels
            ]);
    ...
    elseif ($timeFrame === '1M') {
        ...
        try {
            ...
            foreach ($data as $row) {
                ...
                $ammoniaLevels[] = round($row['ammonia_level'], 2); // Round ammonia level to 2 decimal points
            }

        ...
        fetch(`getDataPh.php?timeFrame=${timeFrame}`)
            ...
            .then(data => {
                ...
                const options = {
                    ...
                    stroke: { curve: 'smooth' },
                    title: { text: 'Dissolved Oxygen Prediction', align: 'left' },
                    grid: {
                        row: {
                    ...
                    yaxis: {
                        min: 0,
                        max: 15,
                        title: { text: 'Dissolved Oxygen Level' },
                ...
                chart = new ApexCharts(document.querySelector("#predict-chart"), options);
                chart.render();
            })
